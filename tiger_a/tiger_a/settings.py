"""
Django settings for tiger_a project.
...
WSGI_APPLICATION = 'tiger_a.wsgi.application'
...
DATABASES = {
    'default': {
       ...
       'HOST': client.access_secret_version(name='projects/sample-groi/secrets/productionHost/versions/latest').payload.data.decode('UTF-8').strip(),
